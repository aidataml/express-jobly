...
// Test the finaAll jobs function
describe("findAll", function () {
  ...
  test("works with a min salary", async function () {
  ...
  test("works with minimum salary and equity", async function () {
  ...
  test("works with a title", async function () {
